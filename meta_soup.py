...
ICAO = ['EDDL', 'EDDN', 'EDDK', 'ETAD', 'ETSB', 'EDFH', 'ETAR', 'EDDR', 'EDTL', 'EDTL', 'EDSB', 'EDFM', 'EDDF', 'ETHF', 'EDVK', 'EDLP', 'EDBC', 'EDDE', 'EDDP', 'ETSH', 'EDDC', 'EDAC', 'EDQM', 'LKKV', 'ETIC',  'ETHN', 'ETIK', 'EDDN', 'ETSI', 'EDMA', 'EDDM', 'ETHA', 'EDNY', 'EDDS', 'ETHL', 'EDJA']
...
def publish(client, airports_count, status):
	...
	#send_timestamp = client.publish("cmnd/weathermap/display", s1)
        # result: [0, 1]
        status = result[0]
        if status == 0:
